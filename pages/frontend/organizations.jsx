...
export default function Organizations() {
  ...
  return (
    <>
      <NavBar />
      <div className="w-full min-h-screen bg-gradient-to-r from-white via-green-100 to-white">
        <div className="w-full py-20 flex items-center md:px-8 px-2 justify-center flex-col">
          <motion.h1
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="text-3xl mt-20 text-center text-green-800 font-bold mb-8"
          >
          ...
          <motion.div
            ...
            className="flex justify-center items-center w-80 border-b-2 border-green-700 mb-8"
          >
            <BiSearch className="text-2xl text-green-700" />
            <input
