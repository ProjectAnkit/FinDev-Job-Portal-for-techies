...
const inputStyles =
  "w-full border border-gray-300 rounded-lg p-3 bg-white bg-opacity-80 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 hover:border-indigo-300";
...
export default function PostAJob() {
  ...
  return (
    <>
      <NavBar />
      <div className="min-h-screen w-full bg-gradient-to-r from-white via-green-100 to-white py-20">
        <div className="container mx-auto px-4 pt-20">
          ...
          >
            <motion.h1
              ...
              className="text-3xl md:text-4xl font-bold text-center text-green-900 mb-2"
            >
              Post a New Job
            </motion.h1>
            <motion.p
              ...
              >
                <button
                  ...
                  className="bg-green-600 text-white px-8 py-3 rounded-lg font-semibold 
                           transform transition-all duration-200 hover:bg-green-600 
