...
export default function DisplayJobs() {
  ...
  return (
    <>
      <NavBar />
      <div className="w-full min-h-screen bg-gradient-to-r from-white via-green-50 to-white">
        <div className="w-full py-20 flex items-center md:px-8 px-2 justify-center flex-col">
          <motion.h1
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="text-xl mt-20 text-center text-green-600 leading-snug font-semibold mb-2 md:text-2xl lg:text-4xl"
          >
            Available Roles
          </motion.h1>
          <motion.div
            ...
            className="flex justify-center items-center w-80 border-b-2 border-green-500 mb-8"
          >
