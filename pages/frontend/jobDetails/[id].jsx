...
export default function JobDetails() {
  ...
  const { data, error, isLoading } = useSWR(
    id ? `/api/job/getSpecifiedJob?id=${id}` : null,
  ...
  return (
    <>
      ...
      <div className="w-full py-20 flex items-center md:px-8 px-2 justify-center flex-col">
        <div className="w-full h-40 bg-gray-50 text-green-700 font-bold flex items-center justify-center flex-col">
          ...
          <div className="flex w-full px-8 md:px-20 items-start md:flex-row flex-col md:justify-between justify-center">
            ...
            <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
              <div className="flex items-center justify-center mb-1">
                <FaUserAstronaut className="text-xs font-semibold text-green-700" />
              ...
              <div className="flex items-center justify-center mb-1">
                <MdEmail className="text-xs font-semibold text-green-700" />
            ...
            <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
              <div className="flex items-center justify-center mb-1">
                <GoLocation className="text-xs font-semibold text-green-700" />
                <p className="font-semibold text-base mx-1  w-20">
                  Location{" "}
                </p>
              ...
              <div className="flex items-center justify-center mb-1">
                <MdCategory className="text-xs font-semibold text-green-700" />
                <p className="font-semibold text-base mx-1  w-20">
                  Category{" "}
                </p>
                <p className=" text-sm text-gray-800 mx-1 ">
            ...
            <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
              <div className="flex items-center justify-center mb-1">
                <BsBriefcaseFill className="text-xs font-semibold text-green-700" />
                <p className="font-semibold text-base mx-1 w-20">
                  Job Type{" "}
                </p>
              ...
              <div className="flex items-center justify-center mb-1">
                <AiOutlineDollarCircle className="text-xs font-semibold text-green-700" />
                <p className="font-semibold text-base mx-1  w-20">
                  Salary{" "}
                </p>
                <p className=" text-sm text-gray-800 mx-1">
              ...
              {JobDetails?.user?.email === user?.email ? (
                ...
                <div className="flex items-center justify-center  ">
                  <BsFillBookmarkCheckFill
                    ...
                    className="text-green-700 text-4xl cursor-pointer  mx-2"
                  />
                  <button
                    onClick={handleApply}
                    className="md:px-6 md:py-3 px-3 py-2 mt-2 md:mt-0 bg-green-500 rounded text-base tracking-widest uppercase transition-all duration-700 hover:bg-green-700 text-white  "
                  >
                    Apply Position
                  </button>
                </div>
        ...
        <div className="w-full md:px-4 py-2 flex items-center md:items-start md:flex-row flex-col justify-start md:justify-center">
          ...
          <div className="md:w-4/12 w-full py-8 px-4 md:px-10">
            ...
            <div className="flex items-center justify-start mb-3">
              <RiUserSearchFill className="text-base font-semibold text-green-700" />
            ...
            <div className="flex items-center justify-start mb-3">
              <BsFillCalendar2DateFill className="text-base font-semibold text-green-700" />
            ...
            <div className="flex items-center justify-start mb-3">
              <HiOutlineStar className="text-base font-semibold text-green-700" />
              <p className="font-semibold text-base mx-1 w-40">
                Experience Required
              </p>
              <p className=" text-sm text-gray-800 mx-1">
                  ...
                  >
                    ...
                    <div className="flex flex-col px-1 md:px-4 py-6 items-start justify-center">
                      <div className="flex px-1 md:px-4 items-center justify-start mb-2">
                        <BsBriefcaseFill className="text-base font-semibold text-green-700" />
                      ...
                      <div className="flex px-1 md:px-4 items-center justify-center mb-2">
                        <AiOutlineDollarCircle className="text-base font-semibold text-green-700" />
                        <p className="font-semibold text-xs md:text-base mx-1 w-28">
                          Salary{" "}
                        </p>
                        <p className=" text-sm text-gray-800 mx-1">
                    ...
                    <button
                      ...
                      className="mx-6 my-2 py-2 px-4  border border-sky-700 uppercase  rounded flex items-center justify-center transition-all duration-700 hover:bg-green-600 hover:text-white text-green-700 font-semibold"
                    >
                      View Detail
