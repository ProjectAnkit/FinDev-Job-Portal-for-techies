  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Find your dream job with FinDeV. Explore opportunities from top companies and make your career dreams come true."
        />
        <meta
          name="keywords"
        ...
        />
        <meta name="author" content="FinDeV_Team" />
        <meta
          property="og:title"
          content="Find Your Dream Job | FinDeV"
        />
        <meta
          name="twitter:title"
          content="Find Your Dream Job | FinDeV"
      ...
      {isLoading ? (
        ...
        <>
          <NavBar />
          <div className="w-full min-h-screen bg-gradient-to-r from-white via-gray-50 to-gray-100 text-gray-700">
            <Intro />
          </div>
        </>
      )}
